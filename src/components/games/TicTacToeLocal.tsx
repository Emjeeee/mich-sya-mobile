  ...
  return (
    <GameCard>
      <View style={styles.scoreRow}>
        <Text style={[styles.scoreText, turn === 'x' && !result && styles.activeX]}>✕ Pemain 1: {scores.x}</Text>
        <Text style={styles.drawText}>Seri: {scores.draw}</Text>
        <Text style={[styles.scoreText, turn === 'o' && !result && styles.activeO]}>○ Pemain 2: {scores.o}</Text>
      </View>
      ...
      <View style={styles.footer}>
        {result ? (
          ...
          <Text style={styles.hintText}>Giliran {turn === 'x' ? 'Pemain 1 (✕)' : 'Pemain 2 (○)'} — gantian pegang HP ya</Text>
        )}
